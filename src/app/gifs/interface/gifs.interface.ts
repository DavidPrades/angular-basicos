...
export class Convert {
    public static toSearchGIFApp(json: string): SearchGIFApp {
        return cast(JSON.parse(json), r("SearchGIFApp"));
    }

    public static searchGIFAppToJson(value: SearchGIFApp): string {
        return JSON.stringify(uncast(value, r("SearchGIFApp")), null, 2);
    }
}
